...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rune Lehrmann
      ...
      <h3 className="home__subtitle">Frontend udvikler</h3>
      <p className="home__description">Passioneret og ambitiøs 
      multimediedesign studerende med fokus på frontend udvikling og med øje for UX og Design.</p>
