          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                Min største kompetence og passion ligger i kodning af
                hjemmesider, hvor jeg kan HTML og CSS til fingerspidserne,
                sammen med JavaScript og React er jeg i stand til at kode en
                hjemmeside fra brunden.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                Jeg designer med bred fokus på brugergrænseflader med UX/UI. Jeg
                bestræber mig altid på at skabe et moderne og brugervenligt
                design, der hænger sammen med virksomhedens identitet.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <h3 className="services__modal-title">Visuelt Design</h3>
              <p className="services__modal-description">
                Jeg kan designe og skabe grafiske elementer til bl.a.
                hjemmesider og annoncer. Til dette benytter jeg primært
                programmer som Photoshop, Illustrator og Adobe XD, som jeg har
                erfaring med igennem min uddannelse.{" "}
              </p>
            </div>
          </div>
        </div>
